                    ...
                    <form id="query-selection" onSubmit={this.handleClick}>
                        <div className = "form-row justify-content-center">
                            <div className="col-md-4 text-center">
                                ...
                                <Select id="pickupZone" onChange = {(e)=> this.handleChange(e,'pickupZone')} options={zoneOptions} />
                            </div>
                            <div className="col-md-4 text-center">
                                <label for="dropoffZone">Dropoff Zone:</label>
                                <Select id="dropoffZone" onChange = {(e)=> this.handleChange(e,'dropoffZone')} options={zoneOptions} />                      
                            </div>
                        </div>
                        <div className = "form-row justify-content-center">
                            <div className="col-md-4 text-center">
